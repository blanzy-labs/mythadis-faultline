...
The author, contributors, and project maintainers are not responsible for any API charges, cloud costs, service usage fees, data loss, business decisions, operational impact, security issues, compliance issues, or other damages that may result from using this application.

AI-generated outputs may be incomplete, inaccurate, biased, misleading, or unsuitable for your specific situation. You should independently review, validate, and verify any outputs before relying on them. This application does not provide legal, financial, medical, security, compliance, or professional advice.
